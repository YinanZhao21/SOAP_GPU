...
solar_name = config.get('data_io','solar_name')
spot_name = config.get('data_io','spot_name')
faculae_name = config.get('data_io','faculae_name')

solar_SED_spectra_name = config.get('data_io','solar_SED_spectra_name')
spot_SED_name = config.get('data_io','spot_SED_name')
faculae_SED_name = config.get('data_io','faculae_SED_name')
...
cmds2 = "./SOAP_integration_solar "+str(GRID)+" "+str(NRHO)+" "+str(int(phase_out.size))+" "+str(Temp)+" "+str(Temp_diff_spot)\
